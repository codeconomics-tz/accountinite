      ...
      items: [
        {
          ...
          icon: 'review-ac',
          description: t`Review your chart of accounts, add any accounts as needed`,
          action: () => routeTo('/chart-of-accounts'),
          fieldname: 'chartOfAccountsReviewed',
          documentation: 'https://www.accountinite-docs.com/setting-up/initial-entries.html#add-additional-bank-accounts',
        },
        {
          ...
          documentation: 'https://www.accountinite-docs.com/setting-up/opening-balances.html',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://www.accountinite-docs.com/entries/items.html',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://www.accountinite-docs.com/entries/party.html',
        },
        {
          ...
          documentation: 'https://www.accountinite-docs.com/transactions/sales-invoices.html',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://www.accountinite-docs.com/transactions/purchase-invoices.html',
        },
      ],
    },
  ];
