  ...
  <div>
    ...
    >
      ...
      <div class="p-4 text-base text-gray-600 dark:text-gray-400">
        {{ t`More shortcuts will be added soon, hopefully.` }}
      </div>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  mounted() {
    this.groups = [
      {
        label: t`Global`,
        description: t`Applicable anywhere in Accountinite`,
        collapsed: false,
        shortcuts: [
          {
          ...
          {
            shortcut: ['F1'],
            description: t`Open Shortcuts`,
          },
          {
            shortcut: [ShortcutKey.ctrl, 'K', 'T'],
            description: t`Toggle between Light and Dark themes`,
          },
        ],
      },
      {
        label: t`Entry`,
        description: t`Applicable when an entry is open in the Form view or Quick Edit view`,
        collapsed: false,
        shortcuts: [
          {
